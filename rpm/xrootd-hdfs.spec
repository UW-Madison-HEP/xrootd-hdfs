...
BuildRequires: xrootd-server-devel >= 1:4.10-1, xrootd-server-devel < 1:4.11.0-1
BuildRequires: xrootd-devel >= 1:4.10-1, xrootd-devel < 1:4.11.0-1
BuildRequires: cmake
...
Requires: xrootd-server >= 1:4.10-1, xrootd-server < 1:4.11.0-1
